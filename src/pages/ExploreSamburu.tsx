    ...
    <div className="container mx-auto px-6">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          Isiolo is the perfect base for exploring Samburu National Reserve. Located just 38 km away, 
        ...
        <Card className="border-border hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Only 38 km from Samburu National Reserve (approx. 35 min drive). Start your game drive in the morning and return to comfort in the evening.
            </p>
          </CardContent>
        </Card>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Drive to Samburu National Reserve (38 km / 35 min drive)</span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="p-8">
              ...
              <CardContent className="p-0">
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-muted-foreground">Only 38 km from Samburu National Reserve (approx. 35 min drive)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
            ...
            <div className="p-8">
              ...
              <CardContent className="p-0">
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-primary mt-0The last code block was cut off at the end. Here’s the continuation and completion of the ExploreSamburu component with the NGO & Research Team section fully included, plus closing the component properly:
ssName="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-muted-foreground">Flexible stay durations for long-term projects</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
